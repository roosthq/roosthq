// Auto-update verification marker, round 2 (2026-08-23) - trivial, no
// behavior change. The 08-22 marker got manually deployed alongside real
// fixes before its own overnight test could run, so this re-baits it.
